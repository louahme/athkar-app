...
class MorningDhikrPage extends StatefulWidget {
  @override
  _MorningDhikrPageState createState() => _MorningDhikrPageState();
}

class _MorningDhikrPageState extends State<MorningDhikrPage> {
  List<Map<String, dynamic>> _dhikrList = [
    {
      'text': 'اللهم بك أصبحنا وبك نموت وبك نحيا',
      'count': 1,
      'completed': false
    },
    {
    ...
    {
      'text': 'باسم الله الذي لا يضر مع اسمه شيء في الأرض ولا في السماء',
      'count': 3,
      'completed': false
    },
    {
      'text':
          'أصبحنا وأصبح الملك لله والحمد لله، لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير، رب أسألك خير ما في هذا اليوم وخير ما بعده وأعوذ بك من شر ما في هذا اليوم وشر ما بعده، رب أعوذ بك من الكسل، وسوء الكِبَرِ، رب أعوذ بك من عذاب في النار، وعذاب في القبر',
      'count': 1,
      'completed': false
    },
    {
    ...
    {
      'text':
          'اللهم عافني في بدني، اللهم عافني في سمعي، اللهم عافني في بصري، لا إله إلا أنت. اللهم إني أعوذ بك من الكفر، والفقر، وأعوذ بك من عذاب في القبر، لا إله إلا أنت',
      'count': 3,
      'completed': false
    },
    {
    ...
    {
      'text':
          'اللهم عالم الغيب والشهادة فاطر السماوات والأرض، رب كل شيء ومليكه، أشهد أن لا إله إلا أنت، أعوذ بك من شر نفسي، ومن شر الشيطان وشِرْكِهِ، وأن أقترف على نفسي سوءاً، أو أجره إلى مسلم',
      'count': 1,
      'completed': false
    },
    {
    ...
    {'text': 'سبحان الله وبحمده', 'count': 100, 'completed': false},
    {
      'text':
    ...
    {
      'text': 'اللهم إني أسألك علما نافعاً، ورزقاً طيباً، وعملاً متقبلاً',
      'count': 1,
      'completed': false
    },
    {'text': 'أستغفر الله وأتوب إليه', 'count': 100, 'completed': false},
    {
      'text': 'أعوذ بكلمات الله التامات من شر ما خلق',
      'count': 3,
      'completed': false
    }
    // قائمة الأذكار كما هي
  ];
                                          ...
                                          setState(() {
                                            if (favoritesProvider
                                              ...
                                              favoritesProvider.addFavorite(
                                                  ...
                                                  backgroundImage:
                                                      'images/class_adkar/1.jpg' // يمكن أن يكون null
                                                  );
                                            }
                                          });
                                        },
